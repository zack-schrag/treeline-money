Currently, the pyplot code is all bundled in with this repo. This should be in it's own separate repo in ~/code/pyplot.
...
- If it's missing tests, add some tests