"""Scatter plot implementation using braille canvas."""

from typing import List

from treeline.pyplot.canvas.braille import BrailleCanvas
from treeline.pyplot.plots.base import Plot
from treeline.pyplot.utils import BOX_LIGHT, format_number, get_axis_range, scale_values


class Scatterplot(Plot):
    """Scatter plot using braille canvas."""
    ...
    def render(self) -> str:
        ...
        Returns:
            String representation of the scatterplot
        """
        ...
        # Get data ranges
        x_min, x_max = get_axis_range(self.x)
        ...
        for x_px, y_px in zip(x_pixels, y_pixels):
            canvas.pixel(int(x_px), int(y_px), self.color)
